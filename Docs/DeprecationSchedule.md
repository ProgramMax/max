...
|-------------|-----------:|-------------------:|------------------------------------|
|Clang 23.1.x |Jul 25, 2026|             Current|                                    |
|Clang 22.1.x |Feb 24, 2026|        Jul 25, 2031|__builtin_stack_address()           |
|Clang 21.1.x |Aug 26, 2025|        Feb 24, 2031|                                    |
|Clang 20.1.x |Mar  4, 2025|        Aug 26, 2030|constexpr placement new             |
|Clang 19.1.x |Sep 17, 2024|        Mar  4, 2030|__builtin_addc                      |
|Clang 18.1.x |Mar  5, 2024|        Sep 17, 2029|deducing this                       |
|Clang 17.0.x |Sep  9, 2023|        Mar  5, 2029|                                    |
...
|Clang 11.0.x |Oct 12, 2020|          Deprecated|                                    |

|GCC version|Release date|max deprecation date|Adds support for                                            |
|-----------|-----------:|-------------------:|------------------------------------------------------------|
|GCC 16.2   |Aug  7, 2026|             Current|                                                            |
|GCC 16.1   |Apr 30, 2026|        Aug  7, 2031|reflection, contracts                                       |
|GCC 15.2   |Aug  8, 2025|        Apr 30, 2031|                                                            |
|GCC 15.1   |Apr 25, 2025|        Aug  8, 2030|#embed                                                      |
|GCC 14.2   |Aug  1, 2024|        Apr 25, 2030|                                                            |
|GCC 14.1   |May  7, 2023|        Aug  1, 2029|deducing this, <stacktrace>, __has_feature & __has_extension|
|GCC 13.2   |Jul 27, 2023|        May  7, 2028|                                                            |
...
|GCC 11.1   |Apr 27, 2021|          Deprecated|std::bit_cast, [[nodiscard]], std::source_location          |

|MSVC version      |Release date|max deprecation date|Adds support for                                    |
|------------------|-----------:|-------------------:|----------------------------------------------------|
|MSVC 18.9.x       |Aug 11, 2026|             Current|                                                    |
|MSVC 18.8.x       |Jul 14, 2026|        Aug 11, 2031|                                                    |
|MSVC 18.7.x       |Jul  9, 2026|        Jul 14, 2031|                                                    |
|MSVC 18.6.x       |May 12, 2026|        Jul  9, 2031|                                                    |
|MSVC 18.5.x       |Apr 14, 2026|        May 12, 2031|                                                    |
|MSVC 18.4.x       |Mar 10, 2026|        Apr 14, 2031|                                                    |
|MSVC 18.3.x       |Feb 10, 2026|        Mar 10, 2031|                                                    |
|MSVC 18.2.x       |Jan 13, 2026|        Feb 10, 2031|                                                    |
...
|MSVC 16.9.x       |Mar  2, 2021|          Deprecated|                                                    |
